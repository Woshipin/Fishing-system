    ...
    const fetchProduct = async () => {
      ...
      const mockProduct = {
        ...
        images: [
          ...
          `https://via.placeholder.com/600x400?text=Product+${id}+Image+4`,
        ],
        ...
        reviews: [
          ...
          },
          {
            ...
            rating: 4,
            date: "2023-04-22",
            comment: "Good product for the price. Would recommend to others looking for something similar.",
          },
          {
            id: 3,
            user: "Mike Johnson",
        ...
        relatedProducts: [
          {
            ...
            price: Math.floor(Math.random() * 200) + 20,
            imageUrl: `https://via.placeholder.com/400x300?text=Related+${parseInt(id) + 1}`,
            category: ["Electronics", "Home", "Clothing", "Office"][Math.floor(Math.random() * 4)],
          },
          {
            id: parseInt(id) + 2,
            ...
            price: Math.floor(Math.random() * 200) + 20,
            imageUrl: `https://via.placeholder.com/400x300?text=Related+${parseInt(id) + 2}`,
            category: ["Electronics", "Home", "Clothing", "Office"][Math.floor(Math.random() * 4)],
          },
          {
            id: parseInt(id) + 3,
            ...
            price: Math.floor(Math.random() * 200) + 20,
            imageUrl: `https://via.placeholder.com/400x300?text=Related+${parseInt(id) + 3}`,
            category: ["Electronics", "Home", "Clothing", "Office"][Math.floor(Math.random() * 4)],
          },
        ],
      }
            ...
            <ol className="inline-flex items-center space-x-1 md:space-x-3">
              ...
              <li>
                <div className="flex items-center">
                  ...
                  <Link to="/products" className="ml-1 text-gray-600 hover:text-primary md:ml-2">
                    Products
                  </Link>
                </div>
              </li>
              <li aria-current="page">
                <div className="flex items-center">
                  ...
                  <span className="ml-1 text-gray-500 md:ml-2 truncate max-w-xs">{product.name}</span>
                </div>
              </li>
            </ol>
          </nav>
            ...
            <AnimatedSection direction="left" className="space-y-4">
              ...
              <div className="grid grid-cols-4 gap-4">
                {product.images.map((image, index) => (
                  ...
                  >
                    <img src={image || "/placeholder.svg"} alt={`${product.name} thumbnail ${index + 1}`} className="w-full h-20 object-cover" />
                  </div>
                ))}
              </div>
            </AnimatedSection>
              ...
              <div>
                ...
                <div className="mb-4">
                  {product.discountPrice ? (
                    <div className="flex items-center">
                      <span className="text-3xl font-bold text-primary mr-2">${product.price - product.discountPrice}</span>
              ...
              <Card
                ...
                footer={
                  <div className="flex justify-between items-center">
                    ...
                    <Link to={`/products/${relatedProduct.id}`} className="px-4 py-2 rounded-full transition-all duration-300 bg-blue-600 text-white hover:bg-blue-700 shadow-md hover:shadow-lg transform hover:-translate-y-1 text-sm">
                      View Details
                    </Link>
                  </div>
                }
