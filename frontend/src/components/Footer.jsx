      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400 mb-4">Providing high-quality products and services since 2023.</p>
            <div className="flex space-x-4">
              {[
                ...
                <a key={i} href={href} className="text-gray-400 hover:text-primary transition-colors">
