...
const PackageCard = ({
  ...
  buttonLink, // This should be passed as `/packages/${id}`
  category = "Category",
  price = 0,
  rating = 5,
  imageUrls = [],
        ...
        <>
          <motion.img
            ...
            onError={(e) => {
              ...
              // Optionally, you might want to prevent auto-slide or show a specific error state
