...
const AboutPage = () => {
  const teamMembers = [
    ...
    },
    {
      ...
      position: "CTO",
      image: "https://via.placeholder.com/300",
      bio: "John leads our technical team and ensures we stay at the cutting edge of technology.",
    },
    {
      name: "Emily Johnson",
      position: "Design Director",
      image: "https://via.placeholder.com/300",
      bio: "Emily brings creative vision to all our products and oversees the design process.",
    },
    {
      name: "Michael Brown",
      position: "Marketing Manager",
      image: "https://via.placeholder.com/300",
      bio: "Michael develops our marketing strategies and builds our brand presence.",
    },
  ];
  ...
  const milestones = [
    ...
    },
    {
      ...
      description: "Recognized for innovation and excellence in our field.",
    },
    {
      year: "2022",
      title: "Sustainability Initiative",
      description:
        "Launched our commitment to sustainable practices and products.",
    },
  ];
        ...
        <div className="container mx-auto px-4 relative z-10">
          <AnimatedSection className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-white mb-8">
              We're on a mission to transform the industry with innovative
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <AnimatedSection direction="left">
              <img
                ...
                alt="Our Story"
                className="rounded-2xl shadow-lg w-full max-w-md mx-auto h-auto object-cover"
              />
            </AnimatedSection>
        ...
        <div className="container mx-auto px-4">
          ...
          <AnimatedSection className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {teamMembers.map((member, index) => (
              <div
                key={index}
                className="bg-white rounded-2xl shadow-lg border border-blue-300/30 overflow-hidden flex flex-col h-96"
              >
      ...
      <section className="py-16 relative bg-gradient-to-br from-blue-100 to-blue-300 overflow-hidden">
        ...
        <div className="absolute bottom-0 w-full h-1/3 z-0">
          <div className="relative w-full h-full">
            ...
            ></div>
            {/* Foreground buildings with more details */}
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="max-w-5xl mx-auto relative">
            {/* Timeline path - curved like in the reference */}
            <div className="absolute top-12 left-0 right-0 h-full z-0">
              <motion.svg
            ...
            >
              ...
              >
                <div className="w-20 h-20 bg-blue-600 rounded-full flex items-center justify-center text-white text-xl font-bold mb-4 md:mb-0 mx-auto z-20 relative shadow-lg border-4 border-white overflow-hidden">
                  <motion.div 
                  ...
                  />
                  <span className="relative z-10">2010</span>
                </div>
              </motion.div>
                <motion.div 
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <p className="text-gray-600">
                      We introduced our flagship product to the market.
                    </p>
                  </motion.div>
                </motion.div>
                <motion.div 
              ...
              >
                <div className="w-20 h-20 bg-blue-600 rounded-full flex items-center justify-center text-white text-xl font-bold mb-4 md:mb-0 mx-auto z-20 relative shadow-lg border-4 border-white overflow-hidden">
                  ...
                  />
                  <span className="relative z-10">2013</span>
                </div>
              </motion.div>
                <div className="md:w-1/2 order-2 md:order-3"></div>
              </motion.div>

              {/* 2016 Milestone - Right side */}
              <motion.div 
                className="mb-32 flex flex-col md:flex-row items-center relative"
                variants={{
                  hidden: { opacity: 0 },
              ...
              >
                ...
                >
                  <div className="w-20 h-20 bg-blue-600 rounded-full flex items-center justify-center text-white text-xl font-bold mb-4 md:mb-0 mx-auto z-20 relative shadow-lg border-4 border-white overflow-hidden">
                    ...
                    />
                    <span className="relative z-10">2016</span>
                  </div>
                </motion.div>
                <motion.div 
                  className="md:w-1/2 md:pl-10 order-3"
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <p className="text-gray-600">
                      We embraced new technologies to revolutionize our business
                      model.
                    </p>
                  </motion.div>
                </motion.div>
                ...
                >
                  <div className="w-20 h-20 bg-black rounded-full flex items-center justify-center text-white text-xl font-bold mb-4 md:mb-0 mx-auto z-20 relative shadow-lg border-4 border-white">
                    2020
                  </div>
                </motion.div>
                <div className="md:w-1/2 order-2 md:order-3"></div>
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <p className="text-gray-600">
                      We launched our commitment to carbon neutrality and
          ...
          {/* Timeline-themed icons at the bottom */}
          <motion.div 
