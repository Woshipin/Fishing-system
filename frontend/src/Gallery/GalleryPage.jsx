        ...
        <div className="container mx-auto px-4">
              ...
              <button
                ...
                className={`px-6 py-3 rounded-full transition-all duration-300 ${
                  activeCategory === category.id
                    ? "bg-indigo-600 text-white shadow-lg shadow-blue-300/50 border border-blue-400"
                    : "bg-gray-100 text-gray-700 hover:bg-gray-200 hover:shadow-md hover:shadow-blue-200/40 border border-blue-200"
                }`}
              >
                {category.name}
              </button>
          ...
          <AnimatedSection className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredImages.map((image) => (
              ...
              >
                <div
                  className="bg-white rounded-xl shadow-sm overflow-hidden cursor-pointer border border-blue-200 hover:border-blue-300 transition-all duration-300 hover:shadow-lg hover:shadow-blue-200/40"
